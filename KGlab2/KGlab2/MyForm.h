...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->scale_btn = (gcnew System::Windows::Forms::Button());
			...
			this->pictureBox1->Size = System::Drawing::Size(725, 628);
			this->pictureBox1->TabIndex = 0;
			this->pictureBox1->TabStop = false;
			// 
			// scale_btn
			// 
			this->scale_btn->Location = System::Drawing::Point(22, 12);
			this->scale_btn->Name = L"scale_btn";
			this->scale_btn->Size = System::Drawing::Size(129, 32);
			this->scale_btn->TabIndex = 1;
			this->scale_btn->Text = L"Масштаб";
			this->scale_btn->UseVisualStyleBackColor = true;
			this->scale_btn->Click += gcnew System::EventHandler(this, &MyForm::scale_btn_Click);
			// 
			// forward_btn
			// 
			this->forward_btn->Location = System::Drawing::Point(249, 12);
			this->forward_btn->Name = L"forward_btn";
			this->forward_btn->Size = System::Drawing::Size(129, 32);
			this->forward_btn->TabIndex = 2;
			this->forward_btn->Text = L"Перенос";
			this->forward_btn->UseVisualStyleBackColor = true;
			this->forward_btn->Click += gcnew System::EventHandler(this, &MyForm::forward_btn_Click);
			// 
			// circle_btn
			// 
			this->circle_btn->Location = System::Drawing::Point(476, 12);
			this->circle_btn->Name = L"circle_btn";
			this->circle_btn->Size = System::Drawing::Size(129, 32);
			this->circle_btn->TabIndex = 3;
			this->circle_btn->Text = L"Поворот";
			this->circle_btn->UseVisualStyleBackColor = true;
			this->circle_btn->Click += gcnew System::EventHandler(this, &MyForm::circle_btn_Click);
			// 
			// back_btn
			// 
			this->back_btn->Location = System::Drawing::Point(651, 62);
			this->back_btn->Name = L"back_btn";
			this->back_btn->Size = System::Drawing::Size(86, 37);
			this->back_btn->TabIndex = 4;
			this->back_btn->Text = L"Откатить";
			this->back_btn->UseVisualStyleBackColor = true;
			this->back_btn->Click += gcnew System::EventHandler(this, &MyForm::back_btn_Click);
			// 
			// close_btn
			// 
			this->close_btn->Location = System::Drawing::Point(651, 105);
			this->close_btn->Name = L"close_btn";
			this->close_btn->Size = System::Drawing::Size(86, 37);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(651, 19);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(22, 71);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(89, 71);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(22, 114);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(89, 114);
			...
			this->label1->Location = System::Drawing::Point(45, 55);
			...
			this->label2->Location = System::Drawing::Point(110, 55);
			...
			this->label3->Location = System::Drawing::Point(45, 98);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(21, 13);
			this->label3->TabIndex = 13;
			this->label3->Text = L"KX";
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(110, 98);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(21, 13);
			this->label4->TabIndex = 14;
			this->label4->Text = L"KY";
			// 
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(249, 91);
			this->textBox5->Name = L"textBox5";
			this->textBox5->Size = System::Drawing::Size(61, 20);
			this->textBox5->TabIndex = 15;
			// 
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(317, 91);
			...
			this->label5->Location = System::Drawing::Point(270, 71);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(20, 13);
			this->label5->TabIndex = 17;
			this->label5->Text = L"dX";
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(336, 71);
			...
			// textBox7
			// 
			this->textBox7->Location = System::Drawing::Point(476, 71);
			...
			// textBox8
			// 
			this->textBox8->Location = System::Drawing::Point(544, 71);
			...
			this->label7->Location = System::Drawing::Point(500, 55);
			...
			this->label8->Location = System::Drawing::Point(565, 55);
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(476, 114);
			this->textBox9->Name = L"textBox9";
			this->textBox9->Size = System::Drawing::Size(129, 20);
			this->textBox9->TabIndex = 23;
			// 
			// label9
			// 
			this->label9->AutoSize = true;
			this->label9->Location = System::Drawing::Point(525, 98);
			...
			this->ClientSize = System::Drawing::Size(751, 785);
...
private: System::Void scale_btn_Click(System::Object^  sender, System::EventArgs^  e);
